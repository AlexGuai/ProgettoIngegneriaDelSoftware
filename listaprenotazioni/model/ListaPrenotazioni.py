...
class ListaPrenotazioni():
    def __init__(self):
        ...
        if os.path.isfile('listaprenotazioni/data/lista_prenotazioni_salvate.pickle'):
            with open('listaprenotazioni/data/lista_prenotazioni_salvate.pickle', 'rb') as f:
    ...
    def save_data(self):
        with open('listaprenotazioni/data/lista_prenotazioni_salvate.pickle', 'wb') as handle:
